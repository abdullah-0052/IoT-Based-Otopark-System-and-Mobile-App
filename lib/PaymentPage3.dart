...
class PaymentPage3 extends StatefulWidget {
  const PaymentPage3({super.key, required String info});
...
class _PaymentPage3State extends State<PaymentPage3> {
  final ref3 = FirebaseDatabase.instance.ref('Sensor3');
  ...
  void _saveData() async {
    ...
    if (plateNumber.isNotEmpty) {
      await FirebaseFirestore.instance.collection('p3').add({
        'Plaka': plateNumber,
        'Ucret': payment,
      });

      // Update the Realtime Database value to 'DOLU' instead of 'null'
      await ref3.child('Park3').set({'Alan 3': 'DOLU'});
                            ...
                            if (isPaymentStarted) {
                              ...
                              AwesomeDialog(
                                ...
                                btnOkOnPress: () async {
                                  ...
                                  await ref3.child('Park3').update({'Alan 3': 'BOS'});
