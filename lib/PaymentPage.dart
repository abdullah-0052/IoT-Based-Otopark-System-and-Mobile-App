...
class PaymentPage extends StatefulWidget {
  const PaymentPage({super.key, required String info});
...
class _PaymentPageState extends State<PaymentPage> {
  ...
  void _saveData() async {
    ...
    if (plateNumber.isNotEmpty) {
      await FirebaseFirestore.instance.collection('p1').add({
        'Plaka': plateNumber,
        'Ucret': payment,
      });

      // Update the Realtime Database value to 'DOLU' instead of 'null'
      await ref.child('Park1').set({'Alan 1': 'DOLU'});
                            ...
                            if (isPaymentStarted) {
                              ...
                              AwesomeDialog(
                                ...
                                btnOkOnPress: () async {
                                  ...
                                  await ref.child('Park1').update({'Alan 1': 'BOS'});
