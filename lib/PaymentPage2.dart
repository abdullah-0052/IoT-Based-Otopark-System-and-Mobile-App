...
class PaymentPage2 extends StatefulWidget {
  const PaymentPage2({super.key, required String info});
...
class _PaymentPage2State extends State<PaymentPage2> {
  final ref2 = FirebaseDatabase.instance.ref('Sensor2');
  ...
  void _saveData() async {
    ...
    if (plateNumber.isNotEmpty) {
      await FirebaseFirestore.instance.collection('p2').add({
        'Plaka': plateNumber,
        'Ucret': payment,
      });

      // Update the Realtime Database value to 'DOLU' instead of 'null'
      await ref2.child('Park2').set({'Alan 2': 'DOLU'});
                            ...
                            if (isPaymentStarted) {
                              ...
                              AwesomeDialog(
                                ...
                                btnOkOnPress: () async {
                                  ...
                                  await ref2.child('Park2').update({'Alan 2': 'BOS'});
